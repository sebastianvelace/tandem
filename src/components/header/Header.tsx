...
export function Header({
  ...
  return (
    <header className="glass flex h-14 shrink-0 items-center justify-between border-b border-white/[0.08] bg-black/40 px-4">
      <div className="flex items-center gap-2">
        ...
        {onMenuToggle && (
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-md text-[var(--color-text-muted)] transition-colors hover:bg-white/[0.07] hover:text-[var(--color-text)] md:hidden"
          >
            <Menu size={18} />
          </button>
        )}
