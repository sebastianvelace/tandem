...
/*
 * Detalle de tarea (TASK-06/07).
 * Móvil: bottom sheet con backdrop. Desktop: panel lateral deslizable.
 */
export function TaskDetail({
  ...
  return (
    <>
      {/* Backdrop — cubre toda la pantalla, cierra al tocar */}
      <div
      ...
      <aside
        className={[
          "glass flex flex-col bg-black/70",
          // Móvil: bottom sheet deslizable desde abajo
          "fixed inset-x-0 bottom-0 z-40 max-h-[88vh] rounded-t-2xl border-t border-white/[0.1]",
          // Desktop: panel lateral derecho
          "md:relative md:inset-auto md:h-full md:max-h-none md:w-96 md:shrink-0 md:rounded-none md:border-l md:border-t-0 md:border-white/[0.08]",
          "animate-slide-up md:animate-slide-right",
        ].join(" ")}
      >
        {/* Tirador visual en móvil */}
